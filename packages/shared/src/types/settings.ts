...
const COMMERCE_FIELDS: readonly SettingFieldMeta[] = [
  ...
  { key: 'dunning', label: 'Tahsilat yeniden deneme', type: 'json', required: true, default: COMMERCE_SETTINGS_DEFAULTS.dunning, help: '{retryHours:[24,72], pastDueAfterUnpaid:2}.' },
