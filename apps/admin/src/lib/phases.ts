...
export const CURRENT_PHASE: PhaseKey = 'F5';
...
export const PHASES: PhaseInfo[] = [
  ...
  { key: 'F5', title: 'CMS içerik + günlük + yasal + toptan + ayarlar', summary: 'Content / Wholesale / Settings modülleri, ekranlar 9–15.', days: 6, status: 'active' },
