...
export const CURRENT_PHASE: PhaseKey = 'F8';
...
export const PHASES: PhaseInfo[] = [
  ...
  { key: 'F8', title: 'Checkout + sipariş + PayTR + kupon', summary: 'PayTR adaptörü (ADR-0019), checkout, callback, kupon, ekranlar 17 ve 23.', days: 6, status: 'active' },
